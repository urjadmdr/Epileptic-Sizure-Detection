...
def registration():
    ...
    def LOGIN():
        ...
        def register():
            user_name = registration_no.get() #get password from entry/user
            password = psw.get() #get password from entry/user

            sql = "INSERT INTO login_info (id, pswd) VALUES (%s, %s)"   #insert values entered by user to table
